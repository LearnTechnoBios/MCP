...
async def get_mcpreadme() -> str:
    """Get the contents of mcpreadme.md from the Desktop directory"""
    desktop_path = Path.home() / "Desktop"
    readme_path = desktop_path / "mcpreadme.md"

    try:
        content = await readme_path.read_text()
        return content
    except FileNotFoundError:
        return "Error: mcpreadme.md not found on Desktop"
    except Exception as e:
